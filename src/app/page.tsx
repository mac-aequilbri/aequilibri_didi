...
const CARDS = [
  ...
  { href: "/app/dulong-downs", badge: "uc2-badge", tag: "UC2", title: "Didi — Dulong Downs", desc: "Single long-project instance on the platform core: tool-use assistant, learning rules, approval-gated writes." },
  { href: "/app", badge: "uc3-badge", tag: "UC3", title: "MSME Coordinator", desc: "Multi-tenant construction PM on the platform core: projects, risks, variations, client portal, AI reports." },
];
